...
User2 = User(name="the boy",
              email="theboy0@gmail.com",
              picture='https://pbs.twimg.com/profile_images/880157232398180356/_0m67-aw_400x400.jpg')
session.add(User2)
session.commit()
...
Item1 = Items(name="Yamaha TF1 Digital Mixing Console",      
            price="$1,999.99",
...
Item2 = Items(name="Mackie ProFX12v2 12-Channel Sound Reinforcement Mixer with Built-In FX",
            price="$249.99",      
...
Item3 = Items(name="Alesis Melody 61 - 61-Key Portable Keyboard with Accessories Kit",
            price="$99.00",
...
Item4 = Items(name="Alesis Forge 8-Piece Electronic Drum Kit with Module",
            price="$499.00",
...
Item5 = Items(name="Shure SM58-LC Dynamic Microphone with Stand & Cable Kit",
            price="$110.99",
...
Item6 = Items(name="QSC K12.2 K.2 Series 12 inch, 2-Way 2000 Watt Powered Speaker",
            price="$799.99",      
...
Item7 = Items(name="Focusrite Scarlett 2i2 USB Audio Interface (2nd Generation)",
            price="$149.99",      
...
Item8 = Items(name="Image-Line FL Studio 12 Producer Edition - Complete Music Production Software (Boxed)",
            price="$199.00",      
