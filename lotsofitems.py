...
category1 = Category(name="Recording",user_id=1)
session.add(category1)
session.commit()
category2 = Category(name="Musical Instruments",user_id=1)
session.add(category2)
session.commit()
category3 = Category(name="Live Sound",user_id=1)
session.add(category3)
session.commit()
category4 = Category(name="Computer Audio",user_id=2)
